<template>
    <div class="w-full max-w-screen-sm h-full mx-auto px-10 py-10 flex flex-col justify-center items-center" style="background-color: #f6f8fb">
        ...
        <!-- 页面标题 -->
        <h1 class="text-4xl text-center my-4" style="color: rgb(14, 69, 160)">登录</h1>
        <!-- 选择导航栏 -->
        <var-tabs v-model:active="activeTab" class="mt-4" active-color="rgb(103, 134, 226)" inactive-color="rgb(180, 188, 215)" color="rgba(231, 235, 249, 56)" style="border-radius: 20px; box-shadow: inset 0 0 4px rgb(159, 178, 234)" indicator-size="3xl">
            <var-tab name="验证码登录">验证码登录</var-tab>
            <var-tab name="密码登录">密码登录</var-tab>
        </var-tabs>
        <!-- 导航栏选项一：验证码登录 -->
        <div v-if="activeTab === '验证码登录'">
            <var-form class="max-w-sm mx-auto my-4 flex flex-col justify-center items-center" style="width: 22rem">
                <!-- 输入email/用户名 -->
