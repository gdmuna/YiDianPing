...
export default {
    ...
    methods: {
        ...
        async deleteQuestion(record) {
            try {
                await comment.deleteQuestion({ comtSubjectId: record.comt_subject_id, questionId: record.question_id });
                this.fetchData();
            } catch (error) {
        ...
        async recoverQuestion(record) {
            try {
                await comment.recoverQuestion({ comtSubjectId: record.comt_subject_id, questionId: record.question_id });
                this.fetchData();
            } catch (error) {
