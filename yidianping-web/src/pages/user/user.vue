    ...
    <var-app-bar fixed safe-area-top style="background-color: #ffffff; color: #0f46a0; box-shadow: none; --app-bar-left-gap: 1rem; --app-bar-right-gap: 1rem">
        ...
        <template #content>
            <div class="flex gap-1 items-center mt-5">
                ...
                <var-button type="primary" class="h-10 rounded-2xl mr-5" color="#ffffff" style="font-size: 0.95rem; letter-spacing: 0.02rem; box-shadow: inset 0 0 4px rgb(159, 178, 234); color: #4e77b9" @click="goSettings">编辑资料</var-button>
            </div>
            <!-- "我的页面"选项卡 -->
